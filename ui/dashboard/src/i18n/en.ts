...
export const en: Dict = {
  ...
  invoices: {
    ...
    note1: 'The browser never reveals the path on disk, only the name: picking a file suggests',
    note2: 'and you can correct it. The native Electron dialog does return the full path.',
